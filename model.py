...
def get_model(input_shape):
    ...
    up1 = layers.TimeDistributed(
        layers.Conv2DTranspose(
            512, kernel_size=(3, 3), padding="same", strides=(2, 2)
        )
    )(x)
    ...
    up2 = layers.TimeDistributed(
        layers.Conv2DTranspose(
            256, kernel_size=(3, 3), padding="same", strides=(2, 2)
        )
    )(x)
    ...
    up3 = layers.TimeDistributed(
        layers.Conv2DTranspose(
            128, kernel_size=(3, 3), padding="same", strides=(2, 2)
        )
    )(x)
